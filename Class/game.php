...
var reverser=1;
var chroma=["#a82020","#c1c71e","#189424","#24207d","#911d80","#1d8c91"];
var colorPicker=0;
// Key Codes
var W = 87;
var S = 83;
...
function init() {
    ...
    if (canvas.getContext) {
        ...
        leftPaddle = makeRect(25, canvas.height / 2 - paddleHeight / 2, paddleWidth, paddleHeight, 5, '#231269');
        rightPaddle = makeRect(canvas.width - paddleWidth - 25, canvas.height / 2 - paddleHeight / 2, paddleWidth, paddleHeight, 5, '#691219');
