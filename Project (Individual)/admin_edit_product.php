	...
	<div class="row">
		...
		<div class="col-4">
			<form method="POST" style="margin-top:10px;">
				<div class="text-center" style="height:600px;padding: 15px 15px 15px 15px; border:2px solid #524f2a; border-radius: 10px; background:#262514; box-shadow: 0 0 15px 1px yellow;">
	...
	<div class="row" style="margin-top:20px;margin-bottom:30px;">
		<div class="col-12 text-center">
			...
			if(isset($_POST["save"])){
				...
				$user = get_user_id();
				$db = getDB();
				$stmt = $db->prepare("UPDATE Y_Products set name=:name, quantity=:quantity, price=:price, description=:description, visibility=:visibility where id=:id");
				$r = $stmt->execute([
					":name"=>$name,
					":quantity"=>$quantity,
					":price"=>$price,
