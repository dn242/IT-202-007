		...
		<div class="collapse navbar-collapse" id="Navbar">
			<ul class="navbar-nav mx-auto">
				...
				<?php if (has_role("Admin")): ?>
					<li class="nav-item"><a class="nav-link" href="test_create_Y_Products.php">Create</a></li>
					<li class="nav-item"><a class="nav-link" href="test_edit_Y_Products.php">Edit</a></li>
				<?php endif; ?>
				<?php if (is_logged_in()): ?>
